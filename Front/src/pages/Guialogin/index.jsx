    ...
    return (
        <>
            ...
            <S.Container>
                ...
                <br />
                <S.Paragraph>
                    Seletividade alimentar refere-se à tendência de uma pessoa
                    preferir certos <br />
                    alimentos e evitar outros, muitas vezes com base em fatores
                    sensoriais, <br />
                    emocionais ou psicológicos. Essa seletividade pode variar de
                    leve a extrema <br />e pode se manifestar de diferentes
                    maneiras:
                </S.Paragraph>{' '}
                <br />
                ...
                <S.List>
                    <S.ListItem>
                        ...
                        afetar suas escolhas alimentares.
                    </S.ListItem>{' '}
                    <br />
                    <S.ListItem>
                        Textura: A textura dos alimentos pode ser um fator
                        importante. Alimentos <br /> crocantes, cremosos ou
                        pegajosos podem ser preferidos ou evitados.
                    </S.ListItem>{' '}
                    <br />
                    <S.ListItem>
                        Aparência: A cor e a aparência dos alimentos também
                        podem influenciar a <br /> aceitação. Alimentos que não
                ...
                <S.List>
                    ...
                    <S.ListItem>
                        ...
                        necessários e como obtê-los de <br /> diferentes fontes
                        alimentares.
                    </S.ListItem>{' '}
                    <br />
                </S.List>
                ...
                <S.List>
                    ...
                    <S.ListItem>
                        ...
                        está afetando sua <br /> qualidade de vida ou suas
