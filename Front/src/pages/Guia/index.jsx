...
const Guia = () => {
    return (
      ...
      <S.Container>
        ...
        <S.List>
          <S.ListItem2> <p> Experiências Passadas: Traumas alimentares ou experiências negativas <br />
           associadas a certos alimentos podem levar a aversões duradouras.</p> </S.ListItem2> <br />
          <S.ListItem2>Associar Comida a Emoções: Alimentos podem estar ligados a experiências <br />
           emocionais ou culturais, afetando a forma como são percebidos e aceitos.</S.ListItem2> <br />
        </S.List>
        <S.SectionTitle>3. Fatores de Saúde</S.SectionTitle>
        <S.List>
          <S.ListItem3>Sensibilidades e Intolerâncias: Condições como intolerância à lactose <br />
           ou alergias alimentares podem levar a uma seletividade alimentar.</S.ListItem3> <br />
          <S.ListItem3>Problemas Digestivos: Algumas pessoas podem evitar certos <br />
           alimentos devido a desconforto digestivo ou problemas <br /> gastrointestinais.</S.ListItem3> <br />
        </S.List>
        ...
        <S.List>
          <S.ListItemAP>Controle e Satisfação: Ter controle sobre o que se come pode levar a uma <br />
           maior satisfação pessoal e bem-estar.</S.ListItemAP> <br />
          <S.ListItemAP>Evitação de Alimentos Não Saudáveis: Às vezes, a seletividade pode resultar <br />
           na eliminação de alimentos processados ou menos saudáveis.</S.ListItemAP> <br />
        </S.List>
        <S.SectionTitle>Aspectos Negativos</S.SectionTitle>
        <S.List>
          <S.ListItemAN>Desbalanço Nutricional: A seletividade alimentar pode levar a deficiências <br />
           nutricionais se não for abordada adequadamente.</S.ListItemAN> <br />
          <S.ListItemAN>Problemas Sociais: Pode causar dificuldades em situações sociais, como <br />
           refeições em grupo ou eventos familiares.</S.ListItemAN> <br />
        </S.List>
        ...
        <S.List>
          <S.ListItemIA><p>Experimentos: Tente introduzir novos alimentos de forma gradual e em <br />
           pequenas quantidades.</p></S.ListItemIA> <br />
          <S.ListItemIA><p>Combinações: Misture novos alimentos com aqueles que você já gosta para <br />
           facilitar a aceitação.</p></S.ListItemIA> <br />
        </S.List>
